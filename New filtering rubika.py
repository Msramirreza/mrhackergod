...
_ __ ___  _ __| |__   __ _  ___| | _____ _ __
| '_ ` _ \| '__| '_ \ / _` |/ __| |/ / _ \ '__|
| | | | | | |  | | | | (_| | (__|   <  __/ |
...
print (Fore.YELLOW + "")
time.sleep(1.7)
print ("                       ID RUBIKA @accountsaz")
print ("                         ID telegram @mrhacker_god_joker")
print ("                          New Id rubika @account_mr")
print(f"{blue} ")
time.sleep(1.0)
print ("__________")
time.sleep(0.7)
...
Account_mr
 """)
print("""
link gap rubikam ==>>>https://rubika.ir/joing/CBFBCAIE0TNEQBWQGWNWTJKBCIPCCKKN
rubika. @accountsaz
""")
print (Fore.WHITE + " ")
time.sleep(3.0)
